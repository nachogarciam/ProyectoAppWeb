 ...
 * @author user
 */
@WebServlet(name = "AgregaJuego", urlPatterns = {"/AgregaJuego"})
public class AgregaJuego extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        fachada.agregar(vj);
        fachada.inventariar(vj, Integer.parseInt(request.getParameter("unidades")));
