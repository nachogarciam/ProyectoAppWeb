    ...
    <body>
        ...
        <div class="container" style="margin-top:9%;">
            <div class="jumbotron">
                ...
                <h6 style="font-size: 100%; text-align: center">Para agregar mas existencias, ingrese la cantidad en el recuadro de abajo</h6>
                <br>
                <form class="form-horizontal" style="margin-left: 25%; margin-right: 30%;" role="form" action="AgregarExJuego" method="get">

                    <div class="form-group form-group-hg">
                        <label class="col-sm-2 control-label" for="formGroupInputHuge"style="width:40%;">Nuevas existencias</label>
                        <div class="col-sm-10" style="width: 57%;">
